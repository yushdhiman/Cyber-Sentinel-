        ...
        <>
          ...
          <div className="cve-grid">
            {filteredCves.map((cve) => {
              ...
              const mitigationText = MITIGATION_GUIDES[cve.id] || 'Audit affected software packages and update system dependencies to their latest secure releases.';
                ...
                >
                  ...
                  {isExpanded && (
                    <div className="cve-remediation-details" onClick={(e) => e.stopPropagation()}>
                      <div className="cve-remediation-title">⬡ ACTIONABLE REMEDIATION PROTOCOL</div>
